      ...
      <Container>
          ...
          <Col>
            <Row>
              <p className="h1 text-start">
                It is <span className="crimson">possible</span> to understand,
                if you receive the{" "}
                <span className="crimson">right support</span>.
              </p>
            </Row>
            <Row>
              <p className="text-start">
        ...
        <Row className="mt-5 p-5 perfect-score">
          <Col md={6}>
            <Row>
              <p className="h1 text-start">
                The score can be <span className="crimson">perfected</span> with
                a push <span className="crimson">here</span> and{" "}
